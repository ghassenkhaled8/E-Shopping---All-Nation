...
def laptop(request, data=None):
    if data == None:
        ...
        laptop = Product.objects.filter(
            category='L').filter(discounted_price__gt=200)
    elif data == 'below':
        laptop = Product.objects.filter(
            category='L').filter(discounted_price__lt=200)
...
def mobile(request, data=None):
    if data == None:
        ...
        mobile = Product.objects.all().filter(
            category='M').filter(discounted_price__gte=200)
    elif data == 'below':
        mobile = Product.objects.all().filter(
            category='M').filter(discounted_price__lt=200)
